...
yy: {},
symbols_: {"error":2,"expressions":3,"e":4,"EOF":5,"(":6,")":7,"method_chain":8,"NUMBER":9,"STRING":10,"BOOL":11,"method":12,"CMP":13,".":14,"key":15,"args":16,"KEY":17,",":18,"ternary":19,"?":20,":":21,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"(",7:")",9:"NUMBER",10:"STRING",11:"BOOL",13:"CMP",14:".",17:"KEY",18:",",20:"?",21:":"},
productions_: [0,[3,2],[4,3],[4,1],[4,1],[4,1],[4,1],[8,1],[8,2],[8,3],[12,1],[12,4],[15,1],[16,3],[16,1],[19,5]],
...
case 1: typeof console !== 'undefined' ? console.log($$[$0-1]) : print($$[$0-1]);
          return $$[$0-1]; 
break;
case 2:this.$ = {code: 'group', value: $$[$0-1]};
break;
case 3:this.$ = {code: 'method', value: $$[$0]};
break;
case 4:this.$ = {code: 'simple', value: Number(yytext)};
break;
case 5:this.$ = {code: 'simple', value: yytext.replace(/(^['"]|['"]$)/g,'')};
break;
case 6:this.$ = {code: 'simple', value: (yytext == 'true')};
break;
case 7:this.$ = {code: 'method', value: $$[$0]};
break;
case 8:this.$ = {code: 'cmp', value: $$[$0]};
break;
case 9:this.$ = {code: 'chain', target: $$[$0-2], rest: $$[$0]};
break;
case 10:this.$ = {code: 'prop', value: $$[$0]};
break;
case 11:this.$ = {code: 'call', name: $$[$0-3], args: $$[$0-1]};
break;
case 12:this.$ = yytext;
break;
case 13:this.$ = {code: 'args', first: $$[$0-2], rest: $$[$0]};
break;
case 14:this.$ = {code: 'arg', value: $$[$0]};
break;
case 15:this.$ = {code: 'if', cond: $$[$0-4], left: $$[$0-2], right: $$[$0]};
break;
}
},
table: [{3:1,4:2,6:[1,3],8:4,9:[1,5],10:[1,6],11:[1,7],12:8,13:[1,9],15:10,17:[1,11]},{1:[3]},{5:[1,12]},{4:13,6:[1,3],8:4,9:[1,5],10:[1,6],11:[1,7],12:8,13:[1,9],15:10,17:[1,11]},{5:[2,3],7:[2,3],18:[2,3]},{5:[2,4],7:[2,4],18:[2,4]},{5:[2,5],7:[2,5],18:[2,5]},{5:[2,6],7:[2,6],18:[2,6]},{5:[2,7],7:[2,7],14:[1,14],18:[2,7]},{8:15,12:8,13:[1,9],15:10,17:[1,11]},{5:[2,10],6:[1,16],7:[2,10],14:[2,10],18:[2,10]},{5:[2,12],6:[2,12],7:[2,12],14:[2,12],18:[2,12]},{1:[2,1]},{7:[1,17]},{8:18,12:8,13:[1,9],15:10,17:[1,11]},{5:[2,8],7:[2,8],18:[2,8]},{4:20,6:[1,3],8:4,9:[1,5],10:[1,6],11:[1,7],12:8,13:[1,9],15:10,16:19,17:[1,11]},{5:[2,2],7:[2,2],18:[2,2]},{5:[2,9],7:[2,9],18:[2,9]},{7:[1,21]},{7:[2,14],18:[1,22]},{5:[2,11],7:[2,11],14:[2,11],18:[2,11]},{4:20,6:[1,3],8:4,9:[1,5],10:[1,6],11:[1,7],12:8,13:[1,9],15:10,16:23,17:[1,11]},{7:[2,13]}],
defaultActions: {12:[2,1],23:[2,13]},
...
rules: [/^(?:\s+)/,/^(?:[0-9]+(\.[0-9]+)?\b)/,/^(?::)/,/^(?:\?)/,/^(?:,)/,/^(?:\()/,/^(?:\))/,/^(?:['"].*['"])/,/^(?:(true|false))/,/^(?:@)/,/^(?:\w[\w\d]*)/,/^(?:\.)/,/^(?:$)/,/^(?:.)/],
