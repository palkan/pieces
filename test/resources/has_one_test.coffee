...
describe "Resources", ->
  describe "HasOne", ->
    ...
    describe "initialization", ->
      ...
      it "add resources created outside with build", ->
    ...
    describe "events", ->
      it "send update on has_one attached", ->
      ...
      it "send update on has_one updated", ->
      ...
      it "send update on has_one destroyed", ->
      ...
      it "not send update when update_if returns false", ->
        usr = User.build(id: 13, name: 'Juan', email: 'juan@dogeater.com')
        usr.on 'update', (spy_fun = sinon.spy())
