describe "autoload list component", ->
  beforeEach ->
    @test_div = $(document.createElement('div'))
    @test_div.css position:'relative'
    $('body').append(@test_div)
    @test_div.append """
        <div class="pi" data-component="list" data-plugins="autoload" data-pi="test" style="position:relative; height: 30px;">
  ...
  describe "autoload plugin", ->
    ...
    it "should send autoload event once per 500ms", (done)->  
      
      spy_fun = sinon.spy()

      @list.on 'autoload', spy_fun
    ...
    it "should send autoload event twice per 1000ms", (done)->  
